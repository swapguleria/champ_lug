...
if (isset($_SESSION['admin_user_id']))
    ...
    //Skipped Tables
    $skipped_tables = array("users", "ad_zones", "admin_user", "module_alias", "fields_admin", "table_icons", "category", "event_category_venue_category", "settings", "fields_mapping", "");
        ...
        elseif ($method == 'event_change')
            ...
            if (@$_POST['event_id'])
                ...
                foreach ($event_categorys as $key => $val)
                    {
                    $a.= "<option value = " . $val['id'] . ">" . ucwords($val["name"]) . "</option>";
                    }
