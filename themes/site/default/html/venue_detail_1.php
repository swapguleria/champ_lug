                ...
                <div class="Concorde_Details">
                    <div class="col-sm-12 text-center">
                        <div class="Concorde_Details_second">
                            <img src="<?php echo main_url; ?>/libs/timthumb/timthumb.php?w=325&h=230&src=<?php echo main_url . "/" . $this->venue['image']; ?>" class="da-thumbs img-thumbnail img-responsive" style="width:100%; height:auto;">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="Concorde_Details_first">
                            ...
                            <ul >
                                ...
                                foreach ($this->venue_details as $key => $val)
                                    {
                                    ?>
                                    <li><a class="venue_detail" id="<?= $val['id'] ?>"><?= $val['name' . $lang] ?></a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="detail clearfix" >
                ...
                <div class="capacity">
                    ...
                    <ul>
                        ...
                        <?php echo (@$this->venue_detail['U-Shaped_capacity']) ? "<li> " . U_Shape . "  : <span>" . $this->venue_detail['U-Shaped_capacity'] . " " . Persons . " </span></li>" : " "; ?><?php echo (@$this->venue_detail['Boardroom_capacity']) ? "<li>" . Boardroom . "   : <span>" . $this->venue_detail['Boardroom_capacity'] . " " . Persons . " </span></li>" : " "; ?>
            ...
            <div class="row">
                ...
                <div class="reviewform col-sm-12">
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <div class="g-recaptcha" data-sitekey="<?= recaptcha_private_key ?>"></div>
...
<style>
    .stars, .Concorde_Details_first > li {  
        cursor: pointer;
    }
</style>
...
//            $('#one, #two').removeClass('fa-star-o').addClass('fa-star');
//            $(this).mouseleave(function () {
//                $('#one, #two').removeClass('fa-star').addClass('fa-star-o');
//            });
//        });
//        THREE.mouseenter(function () {
//            $('#one, #two, #three').removeClass('fa-star-o').addClass('fa-star');
//            $(this).mouseleave(function () {
//                $('#one, #two, #three').removeClass('fa-star').addClass('fa-star-o');
//            });
//        });
//        FOUR.mouseenter(function () {
//            $('#one, #two, #three, #four').removeClass('fa-star-o').addClass('fa-star');
//            $(this).mouseleave(function () {
//                $('#one, #two, #three, #four').removeClass('fa-star').addClass('fa-star-o');
//            });
//        });
//        FIVE.mouseenter(function () {
//            $('#one, #two, #three, #four, #five').removeClass('fa-star-o').addClass('fa-star');
//            $(this).mouseleave(function () {
//                $('#one, #two, #three, #four, #five').removeClass('fa-star').addClass('fa-star-o');
//            });
//        });
//
    });
