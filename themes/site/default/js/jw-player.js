...
"undefined" == typeof jwplayer && (jwplayer = function(h) {
    ...
    (h.embed.config = function(b) { 
        var e = {fallback: !0, height: '470', primary: "html5", width: '100%', left:'0',base: b.base ? b.base : j.getScriptPath("jwplayer.js"), aspectratio: "16:9"};
    ...
    (h.embed.flash = function(b, e, n, a, d) {
        ...
        this.embed = function() {
            ...
            d.config.aspectratio && (g.style.position = "absolute",g.style.left = "0");
            d.container = g;
            d.setPlayer(g, "flash")
        };
...
jwplayer.key = '56VJDo1pXOUIqYKxSpvKdJqmSYzGlqVlnOs2zmfs8jQ=';
if (location.protocol === 'https:') {
    jwplayer.defaults = {flashplayer: 'https://ssl.p.jwpcdn.com/6/10/jwplayer.flash.swf', html5player: 'https://ssl.p.jwpcdn.com/6/10/jwplayer.html5.js', ph: 1}
} else {
    jwplayer.defaults = {flashplayer: 'http://p.jwpcdn.com/6/10/jwplayer.flash.swf', html5player: 'http://p.jwpcdn.com/6/10/jwplayer.html5.js', ph: 1}
}
;